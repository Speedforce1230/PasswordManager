...
void CustomButton::enterEvent(QEnterEvent* event){
    animate.animateColorTransition(this,m_backgroundColor,hover_background_color,"backgroundColor");
    animate.animateColorTransition(this,m_textColor,hover_text_color,"textColor");
    QPushButton::enterEvent(event);
}
void CustomButton::leaveEvent(QEvent* event){
    animate.animateColorTransition(this,m_backgroundColor,initial_background_color,"backgroundColor");
    animate.animateColorTransition(this,m_textColor,initial_text_color,"textColor");
    QPushButton::leaveEvent(event);
}
void CustomButton::mousePressEvent(QMouseEvent* event){
    if (event->button() == Qt::LeftButton){
        timer->stop();
        animate.animateColorTransition(this,m_backgroundColor,click_background_color,"backgroundColor");
        animate.animateColorTransition(this,m_textColor,click_text_color,"textColor");
    }
